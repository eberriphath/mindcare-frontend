    ...
    >
      ...
      <div className="bg-white/20 backdrop-blur-2xl rounded-2xl shadow-2xl p-8 max-w-2xl border border-white/30 mt-10">
        ...
        <p className="text-gray-100 mb-6">
          Your mental wellness companion — connect with therapists, track your
          mood, and take control of your emotional health, all in one place.
        </p>
      ...
      <section className="max-w-5xl mt-20 text-white">
        ...
        <p className="text-lg leading-relaxed text-gray-100 mb-10">
          MindCare is designed to simplify access to mental health support by
          connecting clients with verified therapists and therapy centers,
          encouraging a safe and supportive community, and promoting mental
          wellness through smart tools and automation.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-white/20 p-6 rounded-2xl border border-white/30 backdrop-blur-lg shadow-lg">
            <h3 className="text-xl font-semibold mb-2 text-green-100">
              Simplify Therapy Access
            </h3>
            <p className="text-sm text-gray-200">
              Effortlessly find and book sessions with qualified therapists
              online.
            </p>
          </div>
          <div className="bg-white/20 p-6 rounded-2xl border border-white/30 backdrop-blur-lg shadow-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="bg-white/70 p-6 rounded-2xl shadow-lg flex flex-col items-center hover:scale-105 transition">
            ...
            <p className="text-sm mt-2 text-gray-700">
              View, add, and manage verified therapists easily.
            </p>
          </div>
          <div className="bg-white/70 p-6 rounded-2xl shadow-lg flex flex-col items-center hover:scale-105 transition">
      ...
      <footer className="w-full bg-gradient-to-b from-green-100 to-green-200 text-gray-700 py-10 mt-20 border-t border-green-300">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed">
              MindCare helps clients connect with verified therapists, book
              sessions, and nurture their mental health journey — all in one
              calm, nature-inspired space.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4 mt-4 text-green-700">
              <a href="#" aria-label="Facebook">
                <FaFacebook className="hover:text-green-900 transition-transform transform hover:scale-110" />
              </a>
              <a href="#" aria-label="Twitter">
                <FaTwitter className="hover:text-green-900 transition-transform transform hover:scale-110" />
              </a>
              <a href="#" aria-label="Instagram">
                <FaInstagram className="hover:text-green-900 transition-transform transform hover:scale-110" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-green-300 mt-8 pt-4 text-center text-sm text-gray-600">
          <p>
            ...
            <span className="font-semibold text-green-700">MindCare</span>. All
            Rights Reserved. | Built with ❤️ for Mental Wellness.
          </p>
        </div>
      </footer>
    </div>
