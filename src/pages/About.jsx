...
export default function About() {
  return (
    <div
      className="min-h-screen flex flex-col items-center justify-start bg-cover bg-center text-white p-8 pt-24"
    ...
    >
      ...
      <div className="max-w-4xl bg-white/20 backdrop-blur-2xl rounded-3xl shadow-2xl p-8 border border-white/30 space-y-6 mt-10">
        ...
        <p className="text-lg leading-relaxed">
          <b>MindCare</b> is a mental wellness platform designed to connect clients,
          therapists, and administrators in one supportive digital space. Our mission
          is to make mental health care accessible, personalized, and stigma-free.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mt-6">
          ...
          <div className="bg-white/10 rounded-xl p-5 border border-white/20">
            ...
            <p className="text-gray-200 text-sm leading-relaxed">
              ...
              therapy, track progress, and connect with certified mental health
              professionals.
            </p>
          </div>
        </div>
        ...
        <div className="mt-8">
          ...
          <ul className="list-disc list-inside text-gray-200 text-sm space-y-2">
            <li>
              <b>Clients</b> — seeking guidance, therapy, or self-care tools.
            </li>
            <li>
              <b>Therapists</b> — offering professional mental health support.
            </li>
            <li>
              <b>Admins</b> — managing platform operations and user experiences.
            </li>
          </ul>
        </div>
